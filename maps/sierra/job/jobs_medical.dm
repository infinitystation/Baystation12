...
/datum/job/psychiatrist/get_description_blurb()
	...
	среднестатистческого менталиста из Фонда, и, вероятно, не просто так.<hr>В то время, как Советник склонен к \
	исправлению психологических недугов, поиску псионики и даже чтению мыслей, Менталист может проводить медицинскую \
