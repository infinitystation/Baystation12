/datum/map/sierra
	species_to_job_whitelist = list(
		/datum/species/adherent = list(/datum/job/ai, /datum/job/cyborg, /datum/job/assistant, /datum/job/janitor,\
									   ...
									   /datum/job/doctor_trainee, /datum/job/engineer, /datum/job/infsys, /datum/job/engineer_trainee,\
									   /datum/job/mining, /datum/job/explorer, /datum/job/explorer_engineer,\
