...
#define HUMAN_ONLY_JOBS /datum/job/captain, /datum/job/hos
	species_to_job_blacklist = list(
		/datum/species/unathi  		 = list(HUMAN_ONLY_JOBS, /datum/job/iaa, /datum/job/officer, /datum/job/security_assistant,\
									/datum/job/warden, /datum/job/hos),
		/datum/species/unathi/yeosa  = list(HUMAN_ONLY_JOBS, /datum/job/iaa, /datum/job/officer, /datum/job/security_assistant,\
									/datum/job/warden, /datum/job/hos),
		/datum/species/unathi/erosan = list(HUMAN_ONLY_JOBS, /datum/job/iaa, /datum/job/officer, /datum/job/security_assistant,\
									/datum/job/warden, /datum/job/hos),
		/datum/species/skrell  		 = list(HUMAN_ONLY_JOBS, /datum/job/officer, /datum/job/security_assistant,\
									/datum/job/warden, /datum/job/hos),
		/datum/species/tajaran 		 = list(HUMAN_ONLY_JOBS, /datum/job/officer, /datum/job/security_assistant,\
									/datum/job/warden, /datum/job/hos),
		/datum/species/machine 		 = list(HUMAN_ONLY_JOBS, /datum/job/officer, /datum/job/security_assistant,\
									/datum/job/warden, /datum/job/hos),
