...
#define HUMAN_ONLY_JOBS /datum/job/captain, /datum/job/hos, /datum/job/psychiatrist.
	species_to_job_blacklist = list(
		/datum/species/unathi  		 = list(HUMAN_ONLY_JOBS, /datum/job/iaa, /datum/job/captain, /datum/job/hop,
									 /datum/job/rd, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos,
									/datum/job/iaa, /datum/job/adjutant, /datum/job/exploration_leader),
		/datum/species/unathi/yeosa  = list(HUMAN_ONLY_JOBS, /datum/job/iaa, /datum/job/captain, /datum/job/hop,
									 /datum/job/rd, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos,
									/datum/job/iaa, /datum/job/adjutant, /datum/job/exploration_leader),
		/datum/species/unathi/erosan = list(HUMAN_ONLY_JOBS, /datum/job/iaa, /datum/job/captain, /datum/job/hop,
									 /datum/job/rd, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos,
									/datum/job/iaa, /datum/job/adjutant, /datum/job/exploration_leader),
		/datum/species/skrell  		 = list(HUMAN_ONLY_JOBS, /datum/job/iaa, /datum/job/captain, /datum/job/hop,
									 /datum/job/rd, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos,
									/datum/job/iaa, /datum/job/adjutant, /datum/job/exploration_leader),
		/datum/species/tajaran 		 = list(HUMAN_ONLY_JOBS, /datum/job/iaa, /datum/job/captain, /datum/job/hop,
									 /datum/job/rd, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos,
									/datum/job/iaa, /datum/job/adjutant, /datum/job/exploration_leader),
		/datum/species/machine 		 = list(HUMAN_ONLY_JOBS, /datum/job/iaa, /datum/job/captain, /datum/job/hop,
									 /datum/job/rd, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos,
									/datum/job/iaa, /datum/job/adjutant, /datum/job/exploration_leader, /datum/job/security_assistant, /datum/job/psychiatrist),
		/datum/species/resomi  		 = list(HUMAN_ONLY_JOBS, /datum/job/hop,
									 /datum/job/rd, /datum/job/cmo,
									 /datum/job/officer, /datum/job/exploration_leader,\
