...
/datum/map/sierra/map_info(victim)
	...
	to_chat(victim, "Охрана судна укомплектована сотрудниками Службы Безопасности НаноТрайзен и частных предпри&#255;тий. На судне главенствуют корпоративные регуляции НаноТрейзен (https://wiki.infinity-ss13.info/index.php?title=Корпоративные_законы) и коды угроз НТ (https://wiki.infinity-ss13.info/index.php?title=Коды_угрозы_НТ).")
