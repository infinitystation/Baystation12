/datum/map/sierra
	...
	//Holomap offsets
	#define SIERRA_MAP_SIZE 160 // Width and height of compiled in Sierra z levels. 160
	#define SIERRA_HOLOMAP_CENTER_GUTTER 40 // 40px central gutter between columns
	#define SIERRA_HOLOMAP_MARGIN_X ((HOLOMAP_ICON_SIZE - (2*SIERRA_MAP_SIZE) - SIERRA_HOLOMAP_CENTER_GUTTER) / 2) // 100 60
	#define SIERRA_HOLOMAP_MARGIN_Y ((HOLOMAP_ICON_SIZE - (2.8*SIERRA_MAP_SIZE)) / 2) // 60 80
	//list index MUST be the same as map_level index
	holomap_offset_x = list(SIERRA_HOLOMAP_MARGIN_X, SIERRA_HOLOMAP_MARGIN_X, HOLOMAP_ICON_SIZE - SIERRA_HOLOMAP_MARGIN_X - SIERRA_MAP_SIZE)
	holomap_offset_y = list(SIERRA_HOLOMAP_MARGIN_Y + SIERRA_MAP_SIZE*0, SIERRA_HOLOMAP_MARGIN_Y + SIERRA_MAP_SIZE*1, SIERRA_HOLOMAP_MARGIN_Y + SIERRA_MAP_SIZE*0.5)
