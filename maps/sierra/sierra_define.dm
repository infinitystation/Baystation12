...
/datum/map/sierra/map_info(victim)
	...
	to_chat(victim, "Помимо ЧВК в охране, в остальных отделах также присутствуют подр&#255;дчики. Их нан&#255;ли как выдающихс&#255; специалистов в своей области, что превзошли корпоративного кандидата. Как правило, они либо работают на себ&#255;, либо на другую корпорацию - в обоих случа&#255;х, веро&#255;тно, их попытаютс&#255; склонить к заключениию полноценного рабочего контракта с НТ в ущерб основной организации. На судне действуют:")
