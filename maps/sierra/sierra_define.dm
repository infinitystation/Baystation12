...
/datum/map/sierra/map_info(victim)
	...
	to_chat(victim, "Охрана судна укомплектована корпоративными сотрудника из Департамента Службы Безопасности НаноТрайзен и сотрудниками частных предпри&#255;тий осуществл&#255;ющих охрану судна и его персонала, а так же поддержани&#255; пор&#255;дка в удалении от цивилизации.")
