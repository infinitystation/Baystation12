...
/datum/map/sierra/map_info(victim)
	...
	to_chat(victim, "Техническая информаци&#255: если у вас не играет музыка от инструментов и проигрывателей, то вам стоит откатить версию бьенда с самой последней до 1456.")
