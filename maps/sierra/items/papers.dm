...
/obj/item/weapon/paper/sierrau/hideout
	name = "hideout"
	info = "Я стащил сюда самые ценные вещи, которые только можно достать на этом судне. Гидропонные ванны, плакаты, заказанные на ветскрелле, консервы. СБ не должно их искать, так как я прятал их в другом месте, с момента кражи, и только недавно переместил их сюда. С этими вещами я смогу легко прожить здесь, пока мы не долетим до порта, где я и не опубликую компрометирующий корпорацию материал."
