...
/obj/item/weapon/paper/umbra
	...
	<li>Информаци&#255; об экспедиционных находках, которые представл&#255;ют угрозу НаноТрейзен как организации, должна быть отправлена на ЦК под кодовым именем ТЕНЬ. Только капитан, АВД и главы на борту NSV Sierra могут иметь доступ к полученной информации.</li>
