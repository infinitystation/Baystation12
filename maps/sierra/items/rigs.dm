...
/obj/item/clothing/head/helmet/space/rig/command
	...
	species_restricted = list(SPECIES_HUMAN,SPECIES_IPC, SPECIES_TAJARAN) //no available icons for aliens

/obj/item/clothing/suit/space/rig/command
	icon = 'maps/torch/icons/obj/obj_suit_solgov.dmi'
	item_icons = list(slot_wear_suit_str = 'maps/torch/icons/mob/onmob_suit_solgov.dmi')
	species_restricted = list(SPECIES_HUMAN,SPECIES_IPC, SPECIES_TAJARAN)
