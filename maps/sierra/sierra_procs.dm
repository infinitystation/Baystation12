/datum/map/make_maint_all_access(var/radstorm = 0)
	maint_all_access = 1
	if(radstorm)
		priority_announcement.Announce("Ňđĺáîâŕíč˙ ę äîńňóďó ó řëţçîâ â ňĺőíč÷ĺńęčĺ ňîííĺëč âđĺěĺíííî îňęëţ÷ĺíű. Ýęđŕíčđîâŕííűĺ îňńĺęč - ňĺőíč÷ĺńęčĺ ňîííĺëč, ÷ĺëíîęč, ęŕěĺđű çŕęëţ÷ĺíč˙, äîđěčňîđčé.", "Âíčěŕíčĺ!")
	else
		priority_announcement.Announce("Ňđĺáîâŕíč˙ ę äîńňóďó ó řëţçîâ â ňĺőíč÷ĺńęčĺ ňîííĺëč âđĺěĺíííî îňęëţ÷ĺíű.", "Âíčěŕíčĺ!")

/datum/map/revoke_maint_all_access(var/radstorm = 0)
	maint_all_access = 0
	priority_announcement.Announce("Ňđĺáîâŕíč˙ ę äîńňóďó ó řëţçîâ â ňĺőíč÷ĺńęčĺ ňîííĺëč âîńńňŕíîâëĺíű.", "Âíčěŕíčĺ!")
