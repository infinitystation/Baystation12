...
/datum/antagonist/traitor
	...
	protected_jobs = list(/datum/job/captain, /datum/job/hos, /datum/job/warden, /datum/job/detective, /datum/job/officer, /datum/job/iaa, /datum/job/merchant, /datum/job/merchant_trainee)
