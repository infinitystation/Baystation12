...
/datum/antagonist/changeling
	...
	protected_jobs = list(/datum/job/captain, /datum/job/hop, /datum/job/hos, /datum/job/detective, /datum/job/warden, /datum/job/officer, /datum/job/submap/merchant, /datum/job/submap/merchant_trainee)

/datum/antagonist/godcultist
	blacklisted_jobs = list(/datum/job/ai, /datum/job/cyborg, /datum/job/chaplain, /datum/job/submap)
	protected_jobs = list(/datum/job/captain, /datum/job/hop, /datum/job/hos, /datum/job/detective, /datum/job/warden, /datum/job/officer, /datum/job/iaa, /datum/job/submap/merchant, /datum/job/submap/merchant_trainee)
...
/datum/antagonist/traitor
	...
	protected_jobs = list(/datum/job/captain, /datum/job/hop, /datum/job/hos, /datum/job/warden, /datum/job/detective, /datum/job/officer, /datum/job/iaa, /datum/job/submap/merchant, /datum/job/submap/merchant_trainee)
