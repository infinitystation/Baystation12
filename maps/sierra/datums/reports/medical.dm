...
/datum/computer_file/report/recipient/med/recipe/generate_fields()
	...
	add_field(/datum/report_field/signature, "Подпись главного врача", required = 1)
	set_access(access_medical, access_medical)
...
/datum/computer_file/report/recipient/med/insanity_resolution/generate_fields()
	...
	add_field(/datum/report_field/pencode_text, "Постановление главврача", required = 1)
	add_field(/datum/report_field/signature, "Подпись главврача или менталиста(советника)", required = 1)
	...
	set_access(list(access_cmo, access_psychiatrist), list(access_cmo, access_psychiatrist))
