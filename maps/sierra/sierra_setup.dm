...
/datum/map/sierra/map_info(victim)
	...
	to_chat(victim, "<br><span class='danger'>Помощь в случае возникновения некоторых багов в связи с переходом на byond 513:</span>.")
	to_chat(victim, "У вас были включены механические отношения до перехода? Зайдите во вкладку и включите/выключите их, а потом перепишите описание. Ваш персонаж может спавниться... с ошибками, если они сломаны.")
	to_chat(victim, "Вы обнаружили нечитабельные символы? Сообщите об этом в дискорд-канал #reports, пожалуйста (только убедитесь, что об этом уже никто не сообщил).")
