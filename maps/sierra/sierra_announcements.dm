...
/datum/map/sierra/level_x_biohazard_announcement(var/bio_level)
	...
	priority_announcement.Announce("Подтверждено наличие объекта [bio_level] уровня живой угрозы на борту [station_name()] - [msg]. [crew] персоналу требуется предпринять меры по ликвидации угрозы.", "Живая угроза")
