...
/datum/shuttle/autodock/ferry/escape_pod/colonypod
	category = /datum/shuttle/autodock/ferry/escape_pod/colonypod
	sound_takeoff = 'sound/effects/rocket.ogg'
	sound_landing = 'sound/effects/rocket_backwards.ogg'
	var/number

/datum/shuttle/autodock/ferry/escape_pod/colonypod/New()
...
/datum/shuttle/autodock/ferry/escape_pod/colonypod/escape_pod6
	warmup_time = 10
...
/datum/shuttle/autodock/ferry/escape_pod/colonypod/escape_pod7
	warmup_time = 10
...
/datum/shuttle/autodock/ferry/escape_pod/colonypod/escape_pod8
	warmup_time = 10
...
/datum/shuttle/autodock/ferry/escape_pod/colonypod/escape_pod9
	warmup_time = 10
...
/datum/shuttle/autodock/ferry/escape_pod/colonypod/escape_pod10
	warmup_time = 10
...
/datum/shuttle/autodock/ferry/escape_pod/colonypod/escape_pod12
...
/datum/shuttle/autodock/ferry/escape_pod/colonypod/escape_pod13
...
/datum/shuttle/autodock/ferry/escape_pod/colonypod/escape_pod14
...
/datum/shuttle/autodock/ferry/escape_pod/colonypod/escape_pod15
...
/datum/shuttle/autodock/ferry/escape_pod/colonypod/escape_pod116
...
/datum/shuttle/autodock/ferry/escape_pod/colonypod/escape_pod17
...
/datum/shuttle/autodock/ferry/petrov
	...
	ceiling_type = /turf/simulated/floor/shuttle_ceiling/colony
...
/datum/shuttle/autodock/multi/antag/ninja
	...
	announcer = "NSV colony Sensor Array"
...
/obj/effect/shuttle_landmark/colony/deck1/salvage
	name = "Colony - Docking Port"
...
/obj/effect/shuttle_landmark/colony/hangar/exploration_shuttle
	name = "Charon Hangar"
	landmark_tag = "nav_hangar_calypso"
	base_area = /area/quartermaster/hangar
	base_turf = /turf/simulated/floor/plating

/obj/effect/shuttle_landmark/colony/deck1/exploration_shuttle
	name = "Space near Fourth Deck"
	landmark_tag = "nav_deck1_calypso"

/obj/effect/shuttle_landmark/colony/deck2/exploration_shuttle
	name = "Space near Third Deck"
	landmark_tag = "nav_deck2_calypso"

/obj/effect/shuttle_landmark/colony/deck3/exploration_shuttle
	name = "Space near Second Deck"
	landmark_tag = "nav_deck3_calypso"

/obj/effect/shuttle_landmark/colony/deck4/exploration_shuttle
	name = "Space near First Deck"
	landmark_tag = "nav_deck4_calypso"

/obj/effect/shuttle_landmark/colony/deck5/exploration_shuttle
	name = "Space near Bridge"
	landmark_tag = "nav_bridge_calypso"

/obj/effect/shuttle_landmark/colony/transit/exploration_shuttle
	name = "In transit"
...
/obj/effect/shuttle_landmark/colony/hangar/guppy
	name = "Guppy Hangar"
	landmark_tag = "nav_hangar_guppy"
	base_area = /area/quartermaster/hangar
	base_turf = /turf/simulated/floor/plating

/obj/effect/shuttle_landmark/colony/deck1/guppy
	name = "Space near Fourth Deck"
	landmark_tag = "nav_deck1_guppy"

/obj/effect/shuttle_landmark/colony/deck2/guppy
	name = "Space near Third Deck"
	landmark_tag = "nav_deck2_guppy"

/obj/effect/shuttle_landmark/colony/deck3/guppy
	name = "Space near Second Deck"
	landmark_tag = "nav_deck3_guppy"

/obj/effect/shuttle_landmark/colony/deck4/guppy
	name = "Space near First Deck"
	landmark_tag = "nav_deck4_guppy"

/obj/effect/shuttle_landmark/colony/deck5/guppy
	name = "Space near Bridge"
	landmark_tag = "nav_bridge_guppy"

/obj/effect/shuttle_landmark/colony/transit/guppy
	name = "In transit"
...
/obj/effect/shuttle_landmark/colony/transit/blueriver_shuttle
	name = "In transit"
