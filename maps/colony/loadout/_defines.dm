//The following is a list of defs and blacklist to be used (or not) for the Colony loadout.
/datum/map/colony
...
#define ARMED_ROLES list(\
	...
	/datum/job/officer, /datum/job/warden, /datum/job/detective, /datum/job/submap/merchant, /datum/job/submap/merchant_trainee)
