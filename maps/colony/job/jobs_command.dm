/datum/job/captain
	...
	outfit_type = /decl/hierarchy/outfit/job/colony/crew/command/captain
	total_positions = 1
	spawn_positions = 1
	req_admin_notify = 1
...
/datum/job/hop
	...
	outfit_type = /decl/hierarchy/outfit/job/colony/crew/command/hop
	allowed_branches = list(/datum/mil_branch/employee)
	allowed_ranks = list(/datum/mil_rank/civ/nt)
	min_skill = list(	SKILL_BUREAUCRACY = SKILL_ADEPT,
...
/datum/job/rd
	...
	outfit_type = /decl/hierarchy/outfit/job/colony/crew/research/rd
	allowed_branches = list(/datum/mil_branch/employee)
	allowed_ranks = list(/datum/mil_rank/civ/nt)
	min_skill = list(   SKILL_BUREAUCRACY = SKILL_ADEPT,
...
/datum/job/cmo
	...
	outfit_type = /decl/hierarchy/outfit/job/colony/crew/command/cmo
	allowed_branches = list(/datum/mil_branch/employee)
	allowed_ranks = list(/datum/mil_rank/civ/nt)
...
/datum/job/chief_engineer
	...
	minimal_player_age = 21
	outfit_type = /decl/hierarchy/outfit/job/colony/crew/command/chief_engineer
	allowed_branches = list(/datum/mil_branch/employee)
	allowed_ranks = list(/datum/mil_rank/civ/nt)
	min_skill = list(   SKILL_BUREAUCRACY  = SKILL_BASIC,
...
/datum/job/hos
	...
	outfit_type = /decl/hierarchy/outfit/job/colony/crew/command/hos
	allowed_branches = list(/datum/mil_branch/employee)
	allowed_ranks = list(/datum/mil_rank/civ/nt)
	min_skill = list(   SKILL_BUREAUCRACY = SKILL_ADEPT,
...
/datum/job/iaa
	...
	outfit_type = /decl/hierarchy/outfit/job/colony/crew/research/iaa
	allowed_branches = list(/datum/mil_branch/employee)
	allowed_ranks = list(/datum/mil_rank/civ/nt)
...
/datum/job/adjutant
	...
	outfit_type = /decl/hierarchy/outfit/job/colony/crew/command/adjutant
	allowed_branches = list(/datum/mil_branch/employee)
	allowed_ranks = list(/datum/mil_rank/civ/nt)
	min_skill = list(	SKILL_BUREAUCRACY = SKILL_BASIC,
						SKILL_PILOT       = SKILL_ADEPT)
...
/datum/job/adjutant/get_description_blurb()
	return "You are an Adjutant. You do not give orders of your own. You are subordinate to all of command. You handle matters on the bridge and report directly to the Captain and Head of Personnel. You take the colony's helm. You monitor bridge computer programs and communications and report relevant information to command. Sometimes you can also give support for vessel's departments - you have radio keys in bridge's storage for that purpose."
