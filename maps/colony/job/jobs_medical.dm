/datum/job/senior_doctor
	...
	economic_power = 8
	alt_titles = list(
		"Xenosurgeon" = /decl/hierarchy/outfit/job/colony/crew/medical/senior/xenosurgeon,
		"Trauma Surgeon" = /decl/hierarchy/outfit/job/colony/crew/medical/senior/traumasurgeon)
	outfit_type = /decl/hierarchy/outfit/job/colony/crew/medical/senior
...
/datum/job/doctor
	...
	alt_titles = list(
		"Paramedic" = /decl/hierarchy/outfit/job/colony/crew/medical/doctor/paramedic,
		"Virologist" = /decl/hierarchy/outfit/job/colony/crew/medical/doctor/virologist)

	outfit_type = /decl/hierarchy/outfit/job/colony/crew/medical/doctor
	allowed_branches = list(/datum/mil_branch/employee, /datum/mil_branch/contractor)
	allowed_ranks = list(/datum/mil_rank/civ/nt, /datum/mil_rank/civ/contractor)
...
/datum/job/doctor_trainee
	...
	alt_titles = list(
		"Orderly" = /decl/hierarchy/outfit/job/colony/crew/medical/doctor/orderly,
		"Nurse" = /decl/hierarchy/outfit/job/colony/crew/medical/doctor/nurse)
	outfit_type = /decl/hierarchy/outfit/job/colony/crew/medical/doctor
	allowed_branches = list(/datum/mil_branch/employee, /datum/mil_branch/contractor)
	allowed_ranks = list(/datum/mil_rank/civ/nt, /datum/mil_rank/civ/contractor)
	min_skill = list(   SKILL_EVA     = SKILL_BASIC,
...
/datum/job/chemist
	...
	economic_power = 5
	ideal_character_age = 30
	outfit_type = /decl/hierarchy/outfit/job/colony/crew/medical/doctor/chemist
	allowed_branches = list(/datum/mil_branch/employee, /datum/mil_branch/contractor)
	allowed_ranks = list(/datum/mil_rank/civ/nt, /datum/mil_rank/civ/contractor)
...
/datum/job/psychiatrist
	...
	supervisors = "the Chief Medical Officer"
	alt_titles = list(
		"Psychiatrist" = /decl/hierarchy/outfit/job/colony/crew/medical/counselor/psychiatrist,
		"Chaplain" = /decl/hierarchy/outfit/job/colony/crew/medical/counselor/chaplain,
	)
	outfit_type = /decl/hierarchy/outfit/job/colony/crew/medical/counselor
