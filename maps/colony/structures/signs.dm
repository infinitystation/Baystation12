/obj/structure/sign/dedicationplaque
	name = "\improper NSV Colony dedication plaque"
	icon = 'icons/obj/decals.dmi'
	icon_state = "lightplaque"

/obj/structure/sign/dedicationplaque/Initialize()
	. = ..()
	desc = "N.S.V. Colony - Modified Mako Class - NanoTrasen Registry 3525 - Blume Ship Yards, Earth - Fourth Vessel To Bear The Name - Launched [game_year - 12] - Sol Central Government - 'Travels to the abyss always pays off.'"
...
/obj/structure/sign/ecplaque
	...
	icon = 'maps/colony/icons/obj/solgov-decals.dmi'
	icon_state = "ecplaque"
...
/obj/effect/floor_decal/scglogo
	alpha = 230
	icon = 'maps/colony/icons/obj/solgov_floor.dmi'
	icon_state = "1,1"
