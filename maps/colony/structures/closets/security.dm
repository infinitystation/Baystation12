...
/decl/closet_appearance/secure_closet/colony/security
...
/decl/closet_appearance/secure_closet/colony/security/forensics
...
/decl/closet_appearance/secure_closet/colony/security/warden
...
/* unused
/decl/closet_appearance/secure_closet/colony/security/hos
	color = COLOR_WALL_GUNMETAL
	extra_decals = list(
		"stripe_vertical_left_full" = COLOR_NT_RED,
...
*/
/obj/structure/closet/secure_closet/hos/colony
	name = "head of security's cabinet"
	req_access = list(access_hos)
	closet_appearance = /decl/closet_appearance/cabinet/secure

/obj/structure/closet/secure_closet/hos/colony/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/warden/colony
	name = "warden's locker"
	req_access = list(access_warden)
	closet_appearance = /decl/closet_appearance/secure_closet/colony/security/warden

/obj/structure/closet/secure_closet/warden/colony/WillContain()
	return list(
		/obj/item/clothing/suit/armor/pcarrier/medium/nt,
		/obj/item/clothing/head/helmet/nt,
...
/obj/structure/closet/secure_closet/forensics
	...
	closet_appearance = /decl/closet_appearance/secure_closet/colony/security/forensics
...
/obj/structure/closet/secure_closet/security/colony
	name = "security guard's locker"
	req_access = list(access_guard)
	closet_appearance = /decl/closet_appearance/secure_closet/colony/security

/obj/structure/closet/secure_closet/security/colony/WillContain()
	return list(
		/obj/item/clothing/suit/armor/pcarrier/medium/nt,
		/obj/item/clothing/head/helmet/nt,
		/obj/item/device/radio/headset/headset_sec,
