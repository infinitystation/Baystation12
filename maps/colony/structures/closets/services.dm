...
/decl/closet_appearance/secure_closet/colony/hydroponics
	extra_decals = list(
...
/obj/structure/closet/chefcloset_colony
	name = "chef's closet"
	desc = "It's a storage unit for foodservice equipment."
	closet_appearance = /decl/closet_appearance/wardrobe/black

/obj/structure/closet/chefcloset_colony/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/hydroponics_colony //done so that it has no access reqs
	name = "hydroponics locker"
	req_access = list()
	closet_appearance = /decl/closet_appearance/secure_closet/colony/hydroponics

/obj/structure/closet/secure_closet/hydroponics_colony/WillContain()
	return list(
...
/obj/structure/closet/jcloset/colony
	name = "custodial closet"
	desc = "It's a storage unit for janitorial equipment."
	closet_appearance = /decl/closet_appearance/wardrobe/mixed

/obj/structure/closet/jcloset/colony/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/bar_colony/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/chaplain_colony
	name = "chaplain's locker"
	closet_appearance = /decl/closet_appearance/secure_closet/chaplain
	req_access = list(access_chapel_office)

/obj/structure/closet/secure_closet/chaplain_colony/WillContain()
	return list(
