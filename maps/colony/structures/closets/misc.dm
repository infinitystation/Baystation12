...
/decl/closet_appearance/secure_closet/colony/crew
	color = COLOR_GUNMETAL
	extra_decals = list(
		"stripe_vertical_mid_full" =  COLOR_OFF_WHITE
	)

/decl/closet_appearance/secure_closet/colony/corporate
	color = COLOR_GUNMETAL
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_OFF_WHITE
	)

/decl/closet_appearance/secure_closet/colony/corporate/iaa
	extra_decals = list(
...
/obj/structure/closet/secure_closet/iaa
	...
	closet_appearance = /decl/closet_appearance/secure_closet/colony/corporate/iaa
...
/obj/structure/closet/secure_closet/crew
	...
	closet_appearance = /decl/closet_appearance/secure_closet/colony/crew
...
/obj/structure/closet/white_colony
	closet_appearance = /decl/closet_appearance/white

/obj/structure/closet/secure_closet/white_colony
