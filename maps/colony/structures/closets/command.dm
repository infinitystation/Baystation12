...
/decl/closet_appearance/secure_closet/colony/command
	color = COLOR_GUNMETAL
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_GOLD
	)

/decl/closet_appearance/secure_closet/colony/command/adjutant
...
/decl/closet_appearance/secure_closet/colony/command/hop
	extra_decals = list(
		"stripe_vertical_left_full" = COLOR_GOLD,
		"stripe_vertical_right_full" = COLOR_GOLD,
		"command" = COLOR_GOLD
...
/* unused
/decl/closet_appearance/secure_closet/colony/command/captain
	extra_decals = list(
		"stripe_vertical_left_full" = COLOR_GOLD,
...
*/
/obj/structure/closet/secure_closet/captains/colony
	name = "captain's cabinet"
	req_access = list(access_captain)
	closet_appearance = /decl/closet_appearance/cabinet/secure

/obj/structure/closet/secure_closet/captains/colony/WillContain()
	return list(
		...
		/obj/item/device/radio/headset/heads/colony_captain,
		/obj/item/device/radio/headset/heads/colony_captain/alt,
...
/obj/structure/closet/secure_closet/hop/colony
	name = "head of personnel's locker"
	req_access = list(access_hop)
	closet_appearance = /decl/closet_appearance/secure_closet/colony/command/hop

/obj/structure/closet/secure_closet/hop2
	closet_appearance = /decl/closet_appearance/secure_closet/colony/command/hop

/obj/structure/closet/secure_closet/hop/colony/WillContain()
	return list(
		/obj/item/clothing/glasses/sunglasses,
		/obj/item/clothing/suit/armor/pcarrier/medium,
		/obj/item/clothing/head/helmet,
...
/obj/structure/closet/secure_closet/adjutant
	...
	closet_appearance = /decl/closet_appearance/secure_closet/colony/command/adjutant
