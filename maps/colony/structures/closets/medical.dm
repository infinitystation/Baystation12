...
/obj/structure/closet/secure_closet/CMO_colony
	name = "chief medical officer's locker"
	req_access = list(access_cmo)
	closet_appearance = /decl/closet_appearance/secure_closet/cmo

/obj/structure/closet/secure_closet/CMO_colony/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/medical_colonysenior
	name = "surgeon's locker"
	req_access = list(access_senmed)
	closet_appearance = /decl/closet_appearance/secure_closet/medical/alt

/obj/structure/closet/secure_closet/medical_colonysenior/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/medical_colony
	name = "doctor's locker"
	req_access = list(access_medical_equip)
	closet_appearance = /decl/closet_appearance/secure_closet/medical

/obj/structure/closet/secure_closet/medical_colony/WillContain()
	return list(
		/obj/item/clothing/accessory/storage/white_vest,
		/obj/item/device/radio/headset/headset_med,
		/obj/item/device/radio/headset/headset_med/alt,
...
/obj/structure/closet/wardrobe/medic_colony
	name = "medical wardrobe"
	closet_appearance = /decl/closet_appearance/wardrobe/white

/obj/structure/closet/wardrobe/medic_colony/WillContain()
	return list(
		RANDOM_SCRUBS = 3,
...
/obj/structure/closet/secure_closet/chemical_colony
	name = "chemical closet"
	desc = "Store dangerous chemicals in here."
	closet_appearance = /decl/closet_appearance/secure_closet/medical
	req_access = list(access_chemistry)

/obj/structure/closet/secure_closet/chemical_colony/WillContain()
	return list(
