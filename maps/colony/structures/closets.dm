...
/decl/closet_appearance/secure_closet/colony/excavation
	extra_decals = list(
...
/obj/structure/closet/toolcloset/excavation
	...
	closet_appearance = /decl/closet_appearance/secure_closet/colony/excavation
...
/obj/random/colonycloset //Random closets taking into account colony-specific ones
	name = "random closet"
	desc = "This is a random closet."
	icon = 'icons/obj/closets/bases/closet.dmi'
	icon_state = "base"

/obj/random/colonycloset/spawn_choices()
