...
/area/map_template/crashed_pods
	...
	ambience = list('sound/ambience/crashed_pods/away_pod1.ogg','sound/ambience/crashed_pods/away_pod2.ogg')


/area/map_template/crashed_pods/pod_hydro
	name = "\improper Crashed hydroponic Pod"
	icon_state = "pod_hydro"
	ambience = list('sound/ambience/crashed_pods/pod1.ogg','sound/ambience/crashed_pods/pod2.ogg','sound/ambience/crashed_pods/pod3.ogg')
	sound_env = SMALL_ENCLOSED

/area/map_template/crashed_pods/pod_cargo
	name = "\improper Crashed cargo Pods"
	icon_state = "pod_cargo"
	ambience = list('sound/ambience/crashed_pods/away_pod3.ogg')
...
/area/map_template/crashed_pods/pod_com
	...
	icon_state = "pod_com"
	ambience = list('sound/ambience/crashed_pods/pod_com1.ogg','sound/ambience/crashed_pods/pod_com2.ogg')
	sound_env = SMALL_ENCLOSED
