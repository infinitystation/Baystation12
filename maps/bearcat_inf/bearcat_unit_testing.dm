/datum/map/bearcat
	apc_test_exempt_areas = list(
		...
		/area/ship/scrap/broken1 = NO_SCRUBBER|NO_VENT|NO_APC,
		...
		/area/ship/scrap/crew/hallway = NO_SCRUBBER|NO_VENT,
		/area/ship/scrap/shuttle/outgoing = NO_SCRUBBER,
		/area/ship/scrap/top/aft_solars = NO_SCRUBBER|NO_VENT|NO_APC,
		/area/ship/scrap/top/aft_solars/control = NO_SCRUBBER,
		...
		/area/ship/scrap/top/escape = NO_SCRUBBER|NO_VENT,
