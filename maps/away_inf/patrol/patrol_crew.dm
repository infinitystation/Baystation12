...
/datum/job/submap/patrol
	...
	разведка.\
	\
	Вам запрещено приближаться к кораблям и станциям с опозновательными знаками (то есть это не относится к воксам или пиратам) без разрешения \
	командования или ИскИна (при наличии) обьекта. Исключением являются те ситуации, когда вы терпите бедствие или на вашем шаттле аварийная ситуация."
