/datum/job/submap/bearcat_captain
	...
	info = "Ваш корабль получил катастрофические повреждения, оставшись обесточенным и разбитым в глубинах \
	неисследованного космоса. Капитан погиб, оставив Вас, некогда своего Первого Помощника за главного. Организуйте \
	то, что осталось от вашего экипажа, и возможно, вам удастся прожить достаточно, чтобы найти свое спасение."
...
/datum/job/submap/bearcat_crewman
	...
	info = "Ваш корабль получил катастрофическе повреждения, оставшись обесточенным и разбитым в глубинах \
	неисследованного космоса. Работайте сообща с Первым Помощником и тем что осталось от экипажа, и возможно, \
	вам удастся продержаться достаточно долго, чтобы найти свое спасение."
	required_language = LANGUAGE_SPACER
