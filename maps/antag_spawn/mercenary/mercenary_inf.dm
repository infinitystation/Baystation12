...
/obj/effect/overmap/visitable/merc_base
	...
	desc = "Sensor array detects a medium cargo vessel with high structural damage, crushed into the asteroid."
	in_space = 1
	icon_state = "ship"
...
/var/const/access_merc_leader = "ACCESS_MERC_LEADER"
/datum/access/merc_leader
	id = access_merc_leader
	desc = "Syndicate Leader"
	access_type = ACCESS_TYPE_SYNDICATE

/obj/item/weapon/card/id/syndicate/leader/Initialize()
	. = ..()
	access.Add(access_merc_leader)

/obj/structure/closet/syndicate/ops_gear
	desc = "It's a storage unit for operative gear."
	closet_appearance = /decl/closet_appearance/tactical

/obj/structure/closet/syndicate/ops_gear/Initialize()
	. = ..()
	new /obj/item/weapon/gun/projectile/pistol/military/alt(src)
	new /obj/item/clothing/accessory/storage/holster/thigh(src)
