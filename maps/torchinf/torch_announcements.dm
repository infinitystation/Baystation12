/datum/map/torch
	...
	emergency_shuttle_called_message = "Внимание всему персоналу: начата процедура аварийной эвакуации корабля. До разблокировки спасательных капсул осталось: %ETA%."
...
/datum/map/torch/level_x_biohazard_announcement(var/bio_level)
	if(!isnum(bio_level))
