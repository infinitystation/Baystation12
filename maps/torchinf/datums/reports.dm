...
/datum/computer_file/report/recipient/crew_transfer/generate_fields()
	...
	add_field(/datum/report_field/text_label/header, "The following fields render the document invalid if not signed clearly.")
...
/datum/computer_file/report/recipient/sec/investigation/generate_fields()
	...
	add_field(/datum/report_field/text_label/header, "For internal use only.")
...
/datum/computer_file/report/recipient/sec/incident/generate_fields()
	..()
	add_field(/datum/report_field/text_label/header, "SEV Torch Security Department")
	add_field(/datum/report_field/text_label/header, "To be filled out by Officer on duty responding to the Incident. Report must be signed and submitted before the end of the shift!")
...
/datum/computer_file/report/recipient/fauna/generate_fields()
	...
	add_field(/datum/report_field/text_label/header, "The following is to be filled out by members of a Expedition team after discovery and study of new alien life forms.")
	add_field(/datum/report_field/date, "Date")
	...
	add_field(/datum/report_field/text_label/header, "On completion of this form and form approval, the Research Director should fax the form to both the Corporate Liaison and the Commanding Officer, as well as keep a copy on file in their Office alongside other mission reports.")
...
/datum/computer_file/report/recipient/nt/fire/generate_fields()
	...
	add_field(/datum/report_field/text_label/header, "Please attach employment records alongside notice of termination.")
...
/datum/computer_file/report/recipient/nt/incident/xeno/generate_fields()
	add_field(/datum/report_field/text_label/header, "If non-human employee lacks a valid work visa, use form C-3213A instead.")
	..()
...
/datum/computer_file/report/recipient/nt/incident/xeno_no_visa/generate_fields()
	add_field(/datum/report_field/text_label/header, "If non-human employee has a valid work visa, use form C-3213 instead.")
	..()
	add_field(/datum/report_field/people/list_from_manifest, "Non-Human Employee(s) Involved")
	add_signatures()
...
/datum/computer_file/report/recipient/nt/incident/crew/generate_fields()
	add_field(/datum/report_field/text_label/header, "For multi-party incidents involving both ship crew and company employees.")
	..()
...
/datum/computer_file/report/recipient/nt/volunteer/generate_fields()
	...
	add_field(/datum/report_field/text_label/header, "By signing, the \"Volunteer\" agrees to absolve the Corporation, and its employees, of any liability or responsibility for injuries, damages, property loss or side-effects that may result from the intended procedure. If signed by an authorized representative of the Corporation, such as a Research Director or Executive - this form is deemed reviewed, but is only approved if so marked.")
...
/datum/computer_file/report/recipient/nt/payout/generate_fields()
	...
	add_field(/datum/report_field/text_label/header, "To be shipped and delivered directly to the employee's next of kin without delay.")
	add_field(/datum/report_field/signature, "Signature")
	add_field(/datum/report_field/options/yes_no, "Approved")
	set_access(access_edit = access_nanotrasen)
