...
/datum/antagonist/changeling
	blacklisted_jobs = list(/datum/job/ai, /datum/job/cyborg, /datum/job/submap/merchant, /datum/job/captain, /datum/job/hop, /datum/job/submap)

/datum/antagonist/godcultist
	blacklisted_jobs = list(/datum/job/ai, /datum/job/cyborg, /datum/job/chaplain, /datum/job/submap/merchant, /datum/job/captain, /datum/job/hop, /datum/job/hos, /datum/job/submap)

/datum/antagonist/cultist
	blacklisted_jobs = list(/datum/job/ai, /datum/job/cyborg, /datum/job/chaplain, /datum/job/psychiatrist, /datum/job/submap/merchant, /datum/job/captain, /datum/job/hop, /datum/job/hos, /datum/job/submap)

/datum/antagonist/loyalists
	blacklisted_jobs = list(/datum/job/ai, /datum/job/cyborg, /datum/job/submap/merchant, /datum/job/submap)

/datum/antagonist/revolutionary
	blacklisted_jobs = list(/datum/job/ai, /datum/job/cyborg, /datum/job/submap/merchant, /datum/job/submap)

/datum/antagonist/traitor
	blacklisted_jobs = list(/datum/job/submap/merchant, /datum/job/captain, /datum/job/hop, /datum/job/ai, /datum/job/submap, /datum/job/hos)
