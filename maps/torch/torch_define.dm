...
/datum/map/torch/map_info(victim)
	...
	to_chat(victim, "<b>Это прощальный запуск Торча с 14 до вечера 16 сентября. О багах (кроме критических) с картой докладывать не нужно - стоит оригинальная беевская, дальнейшая доработка не планируется.</b>")
