...
/datum/job/bridgeofficer/get_description_blurb()
	return "You are a Bridge Officer. You are a very junior officer. You do not give orders of your own. You handle matters on the bridge and report directly to the CO and XO. You monitor bridge computer programs and communications and report relevant information to command."

/datum/job/navigationofficer
	title = "Navigation Officer"
	department = "Support"
	department_flag = SPT
	total_positions = 1
	spawn_positions = 1
	supervisors = "the Commanding Officer, the Executive Officer and the Chief Science Officer"
	selection_color = "#2f2f7f"
	minimal_player_age = 0
	economic_power = 7
	ideal_character_age = 24
...
/datum/job/bridgeofficer/get_description_blurb()
	return "You are a Navigation Officer.  You take the Torch's helm and pilot the Aquila if needed."