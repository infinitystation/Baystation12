...
/obj/structure/closet/secure_closet/guncabinet/patrol/assault/WillContain()
	return list(
		...
		/obj/item/weapon/gun/projectile/automatic/invider = 3,
		/obj/item/weapon/gun/projectile/shotgun/magazine = 1,
...
/obj/structure/closet/wardrobe/patrol/WillContain()
	return list(
