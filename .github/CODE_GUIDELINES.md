...
<ul>
	<li>Переменные классов (кроме /tmp/), методы, классы должны быть оформлены в "PascalCase" (исключением являются классы-пресеты, это классы созданные лишь с изменением переменных, не несущие за собой своей, уникальной логики).
