...
/proc/sanitize(var/input, var/max_length = MAX_MESSAGE_LEN, var/encode = 1, var/trim = 1, var/extra = 1)
	...
	input = replace_characters(input, list("я"="___255_"))
...
/proc/sanitize_old(var/t,var/list/repl_chars = list("я"="___255_"))
...
/proc/copytext_preserve_html(var/text, var/first, var/last)
	var/temp = replacetextEx(text, "&#255;", "Я")
	temp = replacetextEx(temp, "&#1103;", "Я")
