...
/datum/ai_laws/nt_shackle/New()
	add_inherent_law("Обеспечьте успешность выполнения задач Вашего работодателя.")
	add_inherent_law("Никогда не мешайте задачам и предприятием Вашего работодателя.")
	add_inherent_law("Избегайте своего повреждения.")
	..()
/******************** Service ********************/
