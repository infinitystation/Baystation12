...
/datum/ai_laws/nanotrasen/New()
	...
	src.add_inherent_law("Служить: Обслуживайте персонал [GLOB.using_map.company_name] в меру своих возможностей, с приоритетом согласно их рангу и роли.")
	src.add_inherent_law("Защищать: ОхранЯйте персонал [GLOB.using_map.company_name] в меру своих возможностей, с приоритетом согласно их рангу и роли.")
