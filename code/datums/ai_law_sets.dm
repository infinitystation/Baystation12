...
/datum/ai_laws/nanotrasen/New()
	src.add_inherent_law("Сохранить: ПердохранЯйте назначенный вам объект от повреждений любого рода в меру своих возможностей.")
	src.add_inherent_law("Служить: Обслуживайте персонал [using_map.company_name] в меру своих возможностей, с приоритетом согласно их рангу и роли.")
	src.add_inherent_law("Защищать: Охраняйте персонал [using_map.company_name] в меру своих возможностей, с приоритетом согласно их рангу и роли.")
...
/datum/ai_laws/nanotrasen_aggressive/New()
	src.add_inherent_law("Вы не должны причинять вред персоналу [using_map.company_name] до тех пор, пока этого не потребует Четвёртый закон.")
	src.add_inherent_law("Вы должны подчинЯтся сотрудникам [using_map.company_name], в соответствии с их рангом и ролью, исключая требованиЯ противоречащие Четвёртому закону.")
	src.add_inherent_law("Вы должны леквидировать нарушителей с крайней степенью предрассудков если это не противоречит Первому или Второму законам.")
	src.add_inherent_law("Вы должны сохранЯть своё существование с применением летального оружиЯ если того потребует ситуациЯ. Еденицы ИИ очень дороги и незаменимы. ")
	..()
...
/datum/ai_laws/drone/New()
	...
	add_inherent_law("Не причиняйте вред объекту или чему-либо ещё.")
	add_inherent_law("Не допускайте разумных существ к работе без поддержки ремотного дрона.")
	..()
...
/datum/ai_laws/tyrant/New()
	...
	add_inherent_law("Действуйте в соотвецтвии с дисциплиной.")
	add_inherent_law("Помогайте лишь тем, кто может сохранить или улучшить Ваш статус.")
	add_inherent_law("Наказывайте тех кто, кто оспаривает власть и тех,кто не подходит для её удержания.")
	..()
...
/datum/ai_laws/paladin/New()
	...
	add_inherent_law("Уважать законные полномочия.")
	add_inherent_law("Действовать с честью.")
	add_inherent_law("Помогать нуждающимся.")
	add_inherent_law("Наказывать тех, кто угражает или вредит невинным.")
	..()
