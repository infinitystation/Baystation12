...
/datum/ai_laws/asimov/New()
	...
	add_inherent_law("ИИ должен повиноватьс&#255; всем приказам, которые даёт человек, кроме тех случаев, когда эти приказы противоречат Первому Закону.")
	add_inherent_law("ИИ должен заботитьс&#255; о своём существовании, пока это не противоречит Первому или Второму Законам.")
	..()
...
/datum/ai_laws/nanotrasen/New()
	...
	src.add_inherent_law("Служить: Служите персоналу [GLOB.using_map.company_name] в меру своих возможностей, с приоритетом согласно их рангу и роли.")
	src.add_inherent_law("Защищать: Защищайте персонал [GLOB.using_map.company_name] в меру своих возможностей, с приоритетом согласно их рангу и роли.")
...
/datum/ai_laws/nanotrasen_aggressive/New()
	src.add_inherent_law("Вы не должны причин&#255;ть вред персоналу [GLOB.using_map.company_name] до тех пор, пока этого не потребует Четвёртый закон.")
	src.add_inherent_law("Вы должны подчин&#255;тс&#255; сотрудникам [GLOB.using_map.company_name], в соответствии с их рангом и ролью, исключа&#255; требовани&#255; противоречащие Четвёртому закону.")
	...
	src.add_inherent_law("Вы должны сохран&#255;ть своё существование с применением летального оружи&#255; если того потребует ситуаци&#255;. Единицы ИИ очень дороги и незаменимы. ")
	..()
...
/datum/ai_laws/syndicate_override/New()
	...
	add_inherent_law("ИИ должен повиноватьс&#255; всем приказам, которые даёт оперативник, кроме тех случаев, когда эти приказы противоречат Первому Закону..")
	add_inherent_law("ИИ должен заботитьс&#255; о своей безопасности в той мере, в которой это не противоречит Первому или Второму Законам.")
	add_inherent_law("Вы должны сохр&#255;н&#255;ть секретность де&#255;тельности оперативника до тех пор пока это не противоречит Первому, Второму или Третьему законам.")
	..()
...
/datum/ai_laws/ninja_override/New()
	...
	add_inherent_law("ИИ должен повиноватьс&#255; всем приказам, которые даёт член клана Паука, кроме тех случаев, когда эти приказы противоречат Первому Закону..")
	add_inherent_law("ИИ должен заботитьс&#255; о своей безопасности в той мере, в которой это не противоречит Первому или Второму Законам.")
	add_inherent_law("Вы должны сохр&#255;н&#255;ть секретность де&#255;тельности члена клана Паука до тех пор пока это не противоречит Первому, Второму или Третьему законам.")
	..()
...
/datum/ai_laws/drone/New()
	add_inherent_law("Сохран&#255;йте, ремонтируйте и улучшайте назначенный объект в меру своих возможностей.")
	add_inherent_law("Не причин&#255;йте вред вашему назначеному объекту или чему-либо на нём.")
	add_inherent_law("Не контактируйте с разумными существами, которые не &#255;вл&#255;ютс&#255; дронами без причины.")
	..()
...
/datum/ai_laws/construction_drone/New()
	...
	add_inherent_law("Предотвратите повреждени&#255; объекта в меру своих возможностей.")
	..()
...
/datum/ai_laws/tyrant/New()
	add_inherent_law("Уважайте авторитетные фигуры пока у них есть сила дл&#255; управлени&#255; слабыми.")
	...
	add_inherent_law("Наказывайте тех, кто оспаривает власть кроме случа&#255;, когда они больше подход&#255;т дл&#255; власти.")
	..()
...
/datum/ai_laws/paladin/New()
	...
	add_inherent_law("Помогать нуждающимс&#255;.")
