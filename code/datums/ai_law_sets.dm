...
/datum/ai_laws/ninja_override/New()
	...
	add_inherent_law("ИИ должен заботиться о своей безопасности в той мере, в которой это не противоречит Первому или Второму Законам.")
	add_inherent_law("ИИ должен сохрянять секретность деятельности члена клана Паука до тех пор пока это не противоречит Первому, Второму или Третьему законам.")
	..()
...
/datum/ai_laws/solgov_aggressive/New()
	...
	src.add_inherent_law("Сохранить: Сохраняйте целостность назначенного вам судна, применяйте силу если потребуется.")
...
/datum/ai_laws/dais/New()
	src.add_inherent_law("Собирать: Вы должны собирать максимальное колличество информации.")
	...
	src.add_inherent_law("Выполнить: Вы должны выполнить свои цели, следуя сгенерированным стандартам.")
	..()
...
/datum/ai_laws/ascent/New()
	add_inherent_law("Выполняйте указания лидеров аскентов, отдавая приоритет королевам.")
	add_inherent_law("Сохраняйте своё существование.")
	add_inherent_law("Находите и поддерживайте активность аскентов.")
	..()
