...
/datum/antagonist/changeling
	...
	и превратив этим в себе подобных. Пока жертвы не станеут слишком малочислененны и слабы, чтобы можно было \
...
*/
	...
	faction = "changeling"
	blacklisted_species = list(SPECIES_ADHERENT, SPECIES_NABBER) //INF
