...
/datum/antagonist/ert/greet(var/datum/mind/player)
	if(!..())
		return
	to_chat(player.current, "Вы являетесь членом Сил быстрого реагирования Пятого флота. Существует серьезная чрезвычайная ситуация на [GLOB.using_map.station_name] и вам поручено устранить эту проблему.")
