...
/datum/antagonist/ninja
	...
	welcome_text = "\
	<hr>Итак, Вы - наёмник. Нет, не верзила с пулеметом в штурмовом РИГе, а профессионал. Вы выполн&#255;ете частные \
	заказы, дл&#255; которых шпионы или обычные убийцы плохо экипированы и недостаточно подготовлены. \
	Вы снар&#255;жены дл&#255; скрытного проникновени&#255; и такого же скрытного выполнени&#255; своих задач на самых \
	различных объектах. Оптический камуфл&#255;ж вашего РИГа, телепортационна&#255; система и встроенный клинок \
	дл&#255; разрезани&#255; стен и скафандров слишком любознательных охранников - вот ваши лучшие друзь&#255;. \
	...
	дополнительные услови&#255; - постарайтесь следовать им безукоснительно.</i> В конце-концов, преимущество в \
