/datum/antagonist
	...
	var/antag_text = "Вы - антагонист! Действуйте как противник по отношению к экипажу. \
		...
		причин (ваша роль не &#255;вл&#255;етс&#255; лицензией на убийство!)</b> Не уходите в рабочую атмосферу раунда и не делайте вид, \
		...
		Старайтесь начинать действовать после получаса (или часа) от начал раунда, не зат&#255;гивайте планированием \
