...
/* How to create an uplink in 3 easy steps!
 ...
 2. Code in the triggers. Use check_trigger for this, I recommend closing the item's menu with "show_browser(usr, null, "window=windowname") if it returns true.
...
// If it returns true, I recommend closing the item's normal menu with "show_browser(user, null, "window=name")"
