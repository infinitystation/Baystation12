...
/obj/item/weapon/book/manual/security_space_law/New()
	...
	dat = {"
		...
		<body>
		<iframe width='100%' height='97%' src="[config.wikiurl]Torch/Corporate_Regulations" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/weapon/book/manual/solgov_law/New()
	...
	dat = {"
		...
		<body>
		<iframe width='100%' height='97%' src="[config.wikiurl]Sol_Central_Government_Law" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/weapon/book/manual/military_law/New()
	...
	dat = {"
		...
		<body>
		<iframe width='100%' height='97%' src="[config.wikiurl]Sol_Code_of_Military_Justice" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/weapon/book/manual/engineering_guide/New()
	...
	dat = {"
		...
		<body>
		<iframe width='100%' height='100%' src="[config.wikiurl]Guide_to_Engineering" frameborder="0" id="main_frame"></iframe>		</body>
