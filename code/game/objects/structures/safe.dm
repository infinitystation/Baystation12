...
/obj/structure/safe/Topic(href, href_list)
	...
	var/canhear = 0
	if(istype(user.l_hand, /obj/item/clothing/accessory/stethoscope) || istype(user.r_hand, /obj/item/clothing/accessory/stethoscope) || user.get_species() == SPECIES_RESOMI)
		canhear = 1
