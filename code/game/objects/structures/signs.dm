...
/obj/structure/sign/nanotrasen
	...
	desc = "Ћоготип корпорации будущего. Ќано - отрожение технологий, “рэйзен - ‘амили€ генерального директора корпорации."
	icon = 'icons/obj/infinity_decals.dmi'
	icon_state = "NT"

/obj/structure/sign/spider_clan
	name = "\improper Spider Clan"
	desc = " лан паука - органиазация, в которой обучаются лучшие наемные убийцы изведанного космоса. ¬ероятно, я счастливчик, раз узнал это."
	icon = 'icons/obj/infinity_decals.dmi'
