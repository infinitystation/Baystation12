...
/datum/universal_state/supermatter_cascade/OnEnter()
	...
	PlayerSet()
	SSskybox.change_skybox(SSskybox.skybox_data ? PICK_OR_SET(SSskybox.skybox_data.cascade_icon_states) : "cascade", new_use_stars = FALSE, new_use_overmap_details = FALSE) //inf, was: SSskybox.change_skybox("cascade", new_use_stars = FALSE, new_use_overmap_details = FALSE)
