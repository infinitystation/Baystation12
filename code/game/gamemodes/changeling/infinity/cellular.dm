...
/datum/cellular_emporium/ui_interact(mob/user, ui_key = "main", /datum/nanoui/ui = null, force_open = FALSE, var/master_ui = null, var/datum/topic_state/state = GLOB.always_state)
...
/datum/cellular_emporium/ui_data(mob/user)
	...
	for(var/path in changeling.all_powers)
		var/datum/changeling_sting/ability = path
