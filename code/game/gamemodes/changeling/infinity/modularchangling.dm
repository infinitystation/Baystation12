...
/datum/power/changeling/hive_download// READ: Don't use the apostrophe in name or desc. Causes script errors.
...
/datum/power/changeling/spiders
	name = "Spread Spiders"
	desc = "Наша оболочка делитьс&#255;, создава&#255; новые формы жизни - пауков."
	helptext = "Пауки могут саботировать работу некоторые отделов и точно застав&#255;т экипаж шевелитьс&#255;, вызывая нестабильность."
	genomecost = 10
...
/datum/power/changeling/armblades
	name = "Mutate Armblades"
	desc = "Позвол&#255;ет нам преобразовывать нашу руку в острое органическое оружие."
	helptext = "Может разрушать неукрепленные стены. Может открывать незаваренные двери без опущенных болтов. Лезвие не исчезнет до тех пор, пока способность не будет использована повторно."
	genomecost = 8
	verbpath = /mob/proc/armblades
...
/datum/power/changeling/MakeSpiders
	name = "Spread Spiders"
	desc = "Наша оболочка делитьс&#255;, создава&#255; новые формы жизни - пауков."
	helptext = "Пауки могут саботировать работу некоторые отделов и точно застав&#255;т экипаж шевелитьс&#255;."
	genomecost = 10
	verbpath = /mob/proc/changeling_spiders
