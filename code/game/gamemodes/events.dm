...
/proc/event()
	...
	switch(pick(eventNumbersToPickFrom))
		if(1)
			command_alert("ћетеоры были обнаружены по курсу станции, приготовьтесь к столкновению.", "“ревога: ћетеоритный пояс")
		...
		if(2)
			command_alert("Ќа станции были зафиксированы гравитационные аномалии. ƒополнительная информация отсутствует.", "“ревога: јномалия")
			for(var/mob/M in player_list)
				if(!istype(M,/mob/new_player))
		...
		if(3) //Leaving the code in so someone can try and delag it, but this event can no longer occur randomly, per SoS's request. --NEO
			command_alert("Ќа станции были зафискированы пространственно-временные аномалии. ƒополнительная информация отсутствует.", "“ревога: јномалия")
...
/proc/alien_infestation(var/spawncount = 1) // -- TLE
	//command_alert("Ќеидентифицированные формы жизни были обнаружены на [station_name()]. ѕроверьте все внешние доступы, а так же вентиляции.", "“ревога: «афиксирована нова€ форма жизни на борту станции")
	...
	spawn(rand(5000, 6000)) //Delayed announcements to keep the crew on their toes.
		command_announcement.Announce("Ќеидентифицированные формы жизни были обнаружены на станции [station_name()]. ѕроверьте все внешние доступы, а так же вентиляции.", "“ревога: «афиксирована новая форма жизни на борту станции", new_sound = 'sound/AI/aliens.ogg')
		...
		if(istype(H,/mob/living/carbon/human))
			...
			if (prob(25))
				if (prob(75))
					...
					domutcheck(H,null,MUTCHK_FORCED)
	sleep(100)
	command_announcement.Announce("«амечен высокий уровень радиации рядом со станцией. ѕожалуйста, обратитесь к врачам если вы чувствуйте себя плохо.", "“ревога: јномалия", new_sound = 'sound/AI/radiation.ogg')
...
/proc/prison_break() // -- Callagan
	...
	if(areas && areas.len > 0)
		...
		sleep(150)
		command_announcement.Announce("Gr3y.T1d3 вирус был обнаружен на станции [station_name()]. –екомендуется вмешательство »».", "“ревога:  омпьютерный вирус")
	else
...
/proc/carp_migration() // -- Darem
	...
	spawn(rand(300, 600)) //Delayed announcements to keep the crew on their toes.
		command_announcement.Announce("Ќеизвестные биологические существа были обнаружены р€дом со станции [station_name()], пожалуйста ожидайте.", "“ревога: «афиксирована нова€ форма жизни на борту станции", new_sound = 'sound/AI/commandreport.ogg')

/proc/lightsout(isEvent = 0, lightsoutAmount = 1,lightsoutRange = 25) //leave lightsoutAmount as 0 to break ALL lights
	if(isEvent)
		command_announcement.Announce("Ёлектрический шторм был зафиксирован в вашем регионе, пожалуйста проверьте и восстановите своЄ оборудование.","“ревога: Ёлектрический шторм")
