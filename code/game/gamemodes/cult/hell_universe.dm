...
/datum/universal_state/hell/OnEnter()
	...
	MiscSet()
	KillMobs()
	SSskybox.change_skybox(SSskybox.skybox_data ? PICK_OR_SET(SSskybox.skybox_data.narsie_icon_states) : "narsie", new_use_stars = FALSE, new_use_overmap_details = FALSE) //inf, was: SSskybox.change_skybox("narsie", new_use_stars = FALSE, new_use_overmap_details = FALSE)
