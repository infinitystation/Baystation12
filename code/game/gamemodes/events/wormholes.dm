/proc/wormhole_event()
	spawn()
		...
		if(pick_turfs.len)
			...
			command_announcement.Announce("Ќа станции были зафискированы пространственно-временные аномалии. ƒополнительная информация отсутствует.", "“ревога: јномалия.", new_sound = 'sound/AI/spanomalies.ogg')
