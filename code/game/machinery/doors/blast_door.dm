...
/obj/machinery/door/blast/proc/force_open()
	operating = 1
	playsound(src.loc, open_sound, 100, need_change_freq) //inf //was: playsound(src.loc, open_sound, 100, 1)
...
/obj/machinery/door/blast/proc/force_close()
	operating = 1
	playsound(src.loc, close_sound, 100, need_change_freq) //inf //was: playsound(src.loc, close_sound, 100, 1)
