...
/obj/machinery/door/firedoor
	...
	blend_objects = list(/obj/machinery/door/firedoor, /obj/structure/wall_frame, /turf/unsimulated/wall, /obj/structure/window, /obj/machinery/door/firedoor, /obj/machinery/door/firedoor) // Objects which to blend with
