...
*/
	...
	В случае событий, повлекших повышение уровня угрозы до уровня Дельта, этот руководство поможет Вам активировать \
	...
	7) Вставьте диск ядерной идентификации в терминал устройства самоуничтожения.<br>\
	8) Введите код доступ в терминал.<br>\
	9) Процесс аворизации завершен. Откройте два стелажа с ядерными цилиндрами. Они вмонтированы в одну из стен помещения.<br>\
	...
	13) Когда вы закончите, переключите предохранителья (кнопка safety).<br>\
