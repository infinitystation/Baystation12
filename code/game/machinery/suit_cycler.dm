/obj/machinery/suit_cycler
	...
	var/list/species = list(SPECIES_HUMAN,SPECIES_SKRELL,SPECIES_UNATHI, SPECIES_RESOMI, SPECIES_TAJARA, SPECIES_EROSAN, SPECIES_NABBER) //inf, was: var/list/species = list(SPECIES_HUMAN,SPECIES_SKRELL,SPECIES_UNATHI, SPECIES_RESOMI, SPECIES_TAJARA, SPECIES_EROSAN)
