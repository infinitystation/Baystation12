...
//[INF]
	"Kazac" = /music_track/kazac,
	"Forever Young" = /music_track/molodoy,
	"Atom" = /music_track/atom,
	"16 tonnes" = /music_track/tonnes,
	"Let in snow" = /music_track/snow,
	"Blue Moon" = /music_track/blue_moon,
	"Big Iron" = /music_track/iron,
	"River Flows in You" = /music_track/river,
	"Novoya Zemlya in window" = /music_track/zemlyane,
	"Love the way you lie" = /music_track/love,
	"Somebody" = /music_track/somebody,
	"Hydrogen" = /music_track/hydrogen,

	"Silence of Space" = /music_track/silence_of_space,
	"Fight with oneself" = /music_track/fight_with_oneself,
//[/INF]
