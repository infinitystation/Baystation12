...
#define UNATHI_SPECIES list(SPECIES_UNATHI, SPECIES_YEOSA)
#define SOUNDED_SPECIES list(SPECIES_HUMAN, SPECIES_VATGROWN, SPECIES_SPACER, SPECIES_TRITONIAN, SPECIES_GRAVWORLDER, SPECIES_MULE, SPECIES_UNATHI, SPECIES_YEOSA, SPECIES_TAJARA, SPECIES_RESOMI, SPECIES_SKRELL)
