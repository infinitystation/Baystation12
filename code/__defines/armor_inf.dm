...
//RESISTENCE EXAMPLES AHEAD
//0  - everything
//10 - light pistols  | mini-smartgun
//20 - common pistols | smartgun, pulse pistol
//30 - rlfes/saw      | laser gun
//40 - z8             | pulse RIFLE
//50 - coder's tears  | xray gun, sniper laser
...
//medium armor, common pistols + light revolvers|smartgun+pulse pistol|common melee|smartgun
...
//medium armor+, heavy pistols, medium revolvers, smg, STS|laser gun, pulse carabine, xray pistol|spear|stun revolver
...
#define ARMOR_RIG_GYYNA ADD_  ADD_ARMOR(45, 45, 45, 60, 40, 100, 85) //ascent gyyna superheavy megamech
