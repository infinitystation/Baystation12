#define CALIBER_PISTOL_TINY     	"5.6mmP" // INF
...
#define CALIBER_RIFLE				"7.62mm" // INF, было #define CALIBER_RIFLE			"5mmR"
#define CALIBER_RIFLE_MILITARY  	"5.56mm" // INF, было #define CALIBER_RIFLE_MILITARY  "7mmR"
