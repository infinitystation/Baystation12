...
#define ALL_NON_ANTAG_LANGUAGES 	list(LANGUAGE_HUMAN_EURO, LANGUAGE_HUMAN_CHINESE, LANGUAGE_HUMAN_SELENIAN, LANGUAGE_HUMAN_ARABIC, LANGUAGE_HUMAN_INDIAN, LANGUAGE_HUMAN_IBERIAN, LANGUAGE_HUMAN_RUSSIAN, LANGUAGE_GUTTER, LANGUAGE_LEGALESE, LANGUAGE_SPACER, LANGUAGE_EAL, LANGUAGE_UNATHI_SINTA, LANGUAGE_UNATHI_YEOSA, LANGUAGE_SKRELLIAN, LANGUAGE_SIIK_MAAS, LANGUAGE_SIIK_TAJR, LANGUAGE_RESOMI, LANGUAGE_ROOTLOCAL, LANGUAGE_ADHERENT, LANGUAGE_VOX, LANGUAGE_NABBER)
