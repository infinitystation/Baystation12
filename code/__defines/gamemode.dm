...
#define ANTAG_IMPLANT_IMMUNE     0x10 // Cannot be loyalty implanted. //On INF it now means "Not brainwashed"
...
#define HOLY_CHECK	    0x400   //INF, will be used by holy constructs
