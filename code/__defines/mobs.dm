...
#define SPECIES_IPC_MORPH   "Morpheus Machine"
#define SPECIES_IPC_HEPH    "Hephaestus Machine"
#define SPECIES_IPC_WARD    "Ward-Takahashi Machine"
#define SPECIES_IPC_BISH    "Bishop Machine"
#define SPECIES_IPC_XION    "Xion Machine"
