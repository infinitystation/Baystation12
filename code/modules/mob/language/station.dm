...
/datum/language/human/get_spoken_verb(var/msg_end)
	if(msg_end == "!!")
		...
		return pick("âîñêëèöàåò")
	else if(copytext(msg_end, length(msg_end)) == "?")
		return pick("ñïðàøèâàåò")
  return speech_verb
...
/datum/language/tajsign
	...
	signlang_verb = list("äåëàåò ïàñû õâîñòîì", "æåñòèêóëèðóåò õâîñòîì", "èñêóñíî æåñòèêóëèðóåò õâîñòîì")
	colour = "tajaran"
	key = "l"
...
/datum/language/nabber
	...
	signlang_verb = list("ñêðèïèò", "ïåðåìàëûâàåò æâàëàìè", "ñêðèïèò è ïåðåìàëûâàåò æâàëàìè")
	key = "n"
	flags = WHITELISTED | SIGNLANG | NO_STUTTER | NONVERBAL
	colour = ".nabber_lang"
	shorthand = "SD"
