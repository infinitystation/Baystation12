...
/mob/living/proc/format_say_message(var/message = null)
	...
	message = replacetext(message, "&#255;", "__:ÃŸ:_") // ÃÃ¨ÃªÃ®Ã¬Ã³ Ã¦Ã¥ Ã¢ Ã£Ã®Ã«Ã®Ã¢Ã³ Ã­Ã¥ Ã¯Ã°Ã¨Ã¤Ã¥Ã² Ã²Ã ÃªÃ®Ã¥ Ã­Ã Ã¯Ã¨Ã±Ã Ã²Ã¼? ~bear1ake@inf-dev
	...
	message = replacetext(message, "__:ÃŸ:_", "&#255;")
	return message
