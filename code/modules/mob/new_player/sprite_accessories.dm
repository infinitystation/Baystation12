...
/datum/sprite_accessory/hair/resomi_mohawk
		name = "Resomi Mohawk"
		icon_state = "resomi_mohawk"
		species_allowed = list(SPECIES_RESOMI)

/datum/sprite_accessory/hair/resomi_pointy
		name = "Resomi Pointy"
		icon_state = "resomi_pointy"
		species_allowed = list(SPECIES_RESOMI)

/datum/sprite_accessory/hair/resomi_upright
		name = "Resomi Upright"
...
/datum/sprite_accessory/hair/resomi_droopy
		name = "Resomi Droopy"
		icon_state = "resomi_droopy"
		species_allowed = list(SPECIES_RESOMI)

/datum/sprite_accessory/hair/resomi_mushroom
