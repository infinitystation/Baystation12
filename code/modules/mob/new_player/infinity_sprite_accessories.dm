...
/datum/sprite_accessory/hair/infinity/longcover
	name = "Longcover"
...
/datum/sprite_accessory/hair/una
	name = "Horns"
	icon = 'icons/mob/lizard_face_inf.dmi'
	icon_state = "horns"
	blend = ICON_MULTIPLY
...
/datum/sprite_accessory/hair/resomi/teshari_fluffymohawk
	name = "Resomi Fluffy Mohawk"
	icon_state = "resomi_fluffymohawk"


/datum/sprite_accessory/marking/resomi
	icon = 'icons/mob/human_races/infinity_markings.dmi'
	species_allowed = list(SPECIES_RESOMI)
	do_colouration = 1

/datum/sprite_accessory/marking/resomi/teshi_fluff
		name = "Resomi underfluff"
		icon_state = "resomi_fluff"
		body_parts = list(BP_L_FOOT,BP_R_FOOT,BP_GROIN,BP_CHEST,BP_HEAD)

/datum/sprite_accessory/marking/resomi/teshi_small_feathers
