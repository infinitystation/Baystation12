/obj/item/weapon/ladder_mobile
	...
	item_icons = list(
		slot_l_hand_str = 'icons/mob/items/mobile_ladders_l.dmi',
		slot_r_hand_str = 'icons/mob/items/mobile_ladders_r.dmi',
		slot_back_str = 'icons/mob/items/mobile_ladders_back.dmi'
		)
