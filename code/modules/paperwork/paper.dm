...
/obj/item/weapon/paper/merchant_mag
	name = "magtables guide"
	info = "<center><b>Руководство по экспалуатации магнитных столов<b><center> На вашем судне установлено 4 новейших магнитных стола. Их ключевой особенностью является возможность примагнитить к столу ЛЮБОЙ предмет. Чтобы заблокировать (примагнитить к столу предметы), нужно всего лишь провести по нему своей картой. После этого предметы будет невозможно взять со стола. Для того чтобы разблокировать стол нужно просто провести по нему картой еще раз."
