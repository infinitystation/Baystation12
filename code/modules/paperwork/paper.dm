...
/obj/item/weapon/paper/reacengi
	...
	info = "<I>Смена #03-A, инженерный департамент произвел модификацию реактивных двигателей. <br>Краткая инструкция по эксплуатации: <br>1) В начале Вашей смены нажмите на все кнопочки над консолью включения/отключения движков. Все должны гореть зеленым. <br>2) Всю смену нажимайте на запальник слева от указанных выше кнопок. <br>3) В случае ЧП, мы <b>не виноваты</b>."
