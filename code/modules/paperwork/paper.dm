...
/obj/item/weapon/paper/merchant
	name = "sell permit"
	info = "<I>Мы учли жалобы сотрудников Торговой Федерации на неразбериху перед консолью покупок. Теперь, дл&#255; произведени&#255; манипул&#255;ций с консолью, требуетс&#255; доступ лидера торговой группы. При&#255;тных продаж.</i>"
...
/obj/item/weapon/paper/compactor
	...
	info = "<I>Обслуживание гидравлического пресса <br>Кратка&#255; инструкци&#255; по эксплуатации: <br>1) Не помещайте крупные объекты в камеру - поршни выйдут из строя. <br>2) В случае поломки одного из поршей (лампочка будет гореть красным) - пройдите в секцию обслуживания поршней, отверткой открутите панель на неисправном поршне, с помощью гаечного ключа выпустите давление из главной камеры. Не забудьте поставить всё на место по завершению процедуры. <br>3) Оденьте рабочие перчатки и противогаз при обслуживании поршня - возможна утечка горячего воздуха.</i>"
