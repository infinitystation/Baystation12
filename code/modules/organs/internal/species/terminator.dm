/obj/item/organ/internal/posibrain/terminator
	...
	origin_tech = list(TECH_ENGINEERING = 6, TECH_MATERIAL = 6, TECH_BLUESPACE = 5, TECH_DATA = 5, TECH_MAGNET = 4)
	req_access = list(access_syndicate)
	shackle = 1 //law manager
	emp_coeff = 0.1

/obj/item/organ/internal/cell/terminator
	name = "advanced microbattery"
	desc = "A small, powerful cell for use in fully prosthetic bodies. Equipped with a Faraday shield."
	servo_cost = 1
	emp_coeff = 0.1

/obj/item/organ/internal/eyes/optics/terminator
