...
//roll to-hit
	if (distance >= 5)
		var/miss_modifier = max(distance_falloff * (distance - 5) * (distance - 5) - hitchance_mod + special_miss_modifier, -30)
	else
		var/miss_modifier = max(0 - hitchance_mod + special_miss_modifier, -30)
	//inf-end
