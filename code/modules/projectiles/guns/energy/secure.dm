...
/obj/item/weapon/gun/energy/secure/gun
	name = "LAEP93 energy gun"
	desc = "A more secure LAEP93, the LAEP90 is designed to please paranoid constituents. Body cam not included."
	icon = 'icons/obj/gun_secure.dmi'
...
/obj/item/weapon/gun/energy/secure/gun/small
	name = "LAEP93-S small energy gun"
	desc = "Combining the two LAEP93 variants, the secure and compact LAEP90-CS is the next best thing to keeping your security forces on a literal leash."
