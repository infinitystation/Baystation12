...
/obj/machinery/power/port_gen/pacman/super/potato
	...
	desc = "PTTO-3, an industrial all-in-one nuclear power plant by Neo-Chernobyl GmbH. It uses uranium and vodka as a fuel source, but water will reduce reactor's temperature gain. Rated for 250 kW max safe output."
	power_gen = 50000			//Watts output per power_output level
	icon_state = "potato"
	max_safe_output = 5
	max_power_output = 8	//The maximum power setting without emagging.
	temperature_gain = 90	//how much the temperature increases per power output level, in degrees per level
	max_temperature = 650
	time_per_sheet = 700
	rad_power = 6
