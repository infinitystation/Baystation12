...
/datum/shuttle/autodock/ferry/specops
	...
	var/obj/item/device/radio/intercom/shuttle_announcer = null
...
/datum/shuttle/autodock/ferry/specops/New()
	..()
	shuttle_announcer = new /obj/item/device/radio/intercom(null)//We need a fake AI to announce some stuff below. Otherwise it will be wonky.
	shuttle_announcer.config(list("Response Team" = 0))

/datum/shuttle/autodock/ferry/specops/proc/radio_announce(var/message)
	if(shuttle_announcer)
		shuttle_announcer.autosay(message, "A.L.I.C.E.", "Response Team")
