// etc unathi with normal legs

/datum/species/erosan
	name = SPECIES_EROSAN
	name_plural = SPECIES_EROSAN
	icobase = 'icons/mob/human_races/species/erosan/body.dmi'
	deform = 'icons/mob/human_races/species/erosan/deformed_body.dmi'
	husk_icon = 'icons/mob/human_races/species/erosan/husk.dmi'
	preview_icon = 'icons/mob/human_races/species/erosan/preview.dmi'
	tail = "sogtail"
	...
	reagent_tag = IS_EROSAN
	base_color = "#066000"
	blood_color = "#f24b2e"
	organs_icon = 'icons/mob/human_races/species/erosan/organs.dmi'
...
/datum/species/erosan/equip_survival_gear(var/mob/living/carbon/human/H)
	..()
	H.equip_to_slot_or_del(new /obj/item/clothing/shoes/sandal(H),slot_shoes)

/datum/species/erosan/proc/handle_sugar(var/mob/living/carbon/human/M, var/datum/reagent/sugar, var/efficiency = 1)
...
/datum/species/erosan/get_bodytype(var/mob/living/carbon/human/H)
