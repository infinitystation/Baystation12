...
/obj/item/clothing/gloves/wristwatch
    name = "wristwatch"
    desc = "Wristwatch. This one is silver and have EMP resistant."
...
/obj/item/clothing/gloves/wristwatch/gold
    name = "wristwatch"
    desc = "Wristwatch. This one is golden and in makes you feel like a boss."
    icon = 'infinity/icons/obj/clothing/obj_hands.dmi'
    item_icons = list(slot_gloves_str = 'infinity/icons/mob/onmob/onmob_hands.dmi')
    icon_state = "wristwatch_gold"
    item_state = "wristwatch_gold"
