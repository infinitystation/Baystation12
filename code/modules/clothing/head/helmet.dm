/obj/item/clothing/head/helmet
	...
	armor = list(melee = 50, bullet = 20, laser = 50,energy = 20, bomb = 30, bio = 0, rad = 0)
...
/obj/item/clothing/head/helmet/tactical
	...
	armor = list(melee = 50, bullet = 40, laser = 60, energy = 45, bomb = 30, bio = 0, rad = 0)
...
/obj/item/clothing/head/helmet/merc
	...
	armor = list(melee = 70, bullet = 40, laser = 70, energy = 35, bomb = 30, bio = 0, rad = 0)
...
/obj/item/clothing/head/helmet/riot
	...
	armor = list(melee = 82, bullet = 20, laser = 5, energy = 5, bomb = 5, bio = 2, rad = 0)
	siemens_coefficient = 0.7
...
/obj/item/clothing/head/helmet/ballistic
	...
	valid_accessory_slots = null
	armor = list(melee = 5, bullet = 50, laser = 30, energy = 5, bomb = 30, bio = 2, rad = 0)
	siemens_coefficient = 0.7
...
/obj/item/clothing/head/helmet/swat
	...
	icon_state = "helmet_merc"
	armor = list(melee = 80, bullet = 40, laser = 50,energy = 25, bomb = 50, bio = 10, rad = 0)
	cold_protection = HEAD
...
/obj/item/clothing/head/helmet/thunderdome
	...
	valid_accessory_slots = null
	armor = list(melee = 80, bullet = 40, laser = 50,energy = 10, bomb = 25, bio = 10, rad = 0)
	cold_protection = HEAD
	min_cold_protection_temperature = SPACE_HELMET_MIN_COLD_PROTECTION_TEMPERATURE
