...
/obj/item/clothing/glasses
	...
	sprite_sheets = list(
		SPECIES_RESOMI = 'infinity/icons/mob/species/resomi/eyes.dmi',
...
/obj/item/clothing/shoes
	...
	force = 2
	var/overshoes = 0
	species_restricted = list("exclude", SPECIES_NABBER, SPECIES_UNATHI, SPECIES_TAJARA, SPECIES_VOX, SPECIES_VOX_ARMALIS, SPECIES_RESOMI)
	sprite_sheets = list(
...
/obj/item/clothing/suit
	...
	valid_accessory_slots = list(ACCESSORY_SLOT_ARMBAND, ACCESSORY_SLOT_OVER) // INF@CODE
...
/obj/item/clothing/under
	...
	sprite_sheets = list(
		...
		SPECIES_RESOMI = 'infinity/icons/mob/species/resomi/uniform.dmi',
	)
