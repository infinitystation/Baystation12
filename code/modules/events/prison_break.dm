...
/datum/event/prison_break/announce()
	if(areas && areas.len > 0)
		command_announcement.Announce("[pick("Gr3y.T1d3 virus","Malignant trojan")] вирус был обнаружен в подпрограммах [station_name()] [(eventDept == "Security")? "imprisonment":"containment"]. Немедленно зафиксируйте все взломанные области. Рекомендуется участие ИИ на станции.", "[eventDept] Alert")
