/datum/event/computer_damage/start()
	...
	while(number_of_victims && victims.len)
		...
		if(prob(50))
			victim.visible_message("<span class='warning'>[victim] издает странные пощелкивани&#255;...</span>") //inf //was: '			victim.visible_message("<span class='warning'>[victim] emits some ominous clicks.</span>")'
