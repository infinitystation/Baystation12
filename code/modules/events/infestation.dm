...
/datum/event/infestation/announce()
	command_announcement.Announce("Ѕиосканеры зафиксировали размножение [vermstring] в [locstring]. »збавьтесь от них, пока это не сказалось на работоспособности станции.", "ѕаразитическое оповещение")
