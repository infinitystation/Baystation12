...
/datum/event/radiation_storm/tick()
	if(activeFor == enterBelt)
		command_announcement.Announce("¬озростание радиационного фона прекращено. Ќасто€тельно рекомендуетс€ оставатьс€ в экранированных помещени€х до снижени€ уровн€ фона.", "—енсоры [location_name()]", zlevels = affecting_z)
		radiate()
