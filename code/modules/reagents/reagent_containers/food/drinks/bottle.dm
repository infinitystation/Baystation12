...
/obj/item/reagent_containers/food/drinks/bottle/bullet_act(var/obj/item/projectile/P, var/chance)
	if(prob(chance))
		smash(loc, P)
	return PROJECTILE_CONTINUE

/obj/item/reagent_containers/food/drinks/bottle/CanPass(atom/movable/mover, turf/target, height=0, air_group=0)
