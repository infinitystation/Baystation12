...
/obj/item/reagent_containers/glass/beaker/large/cryolife //extreme powerfull beaker for cryo
	New()
		..()
...
/obj/item/reagent_containers/glass/jug/pickup(mob/user)
		..()
		update_icon()

/obj/item/reagent_containers/glass/jug/dropped(mob/user)
		..()
		update_icon()

/obj/item/reagent_containers/glass/jug/attack_hand()
		..()
		update_icon()

/obj/item/reagent_containers/glass/jug/on_update_icon()
	overlays.Cut()
