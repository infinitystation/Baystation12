...
/datum/category_item/player_setup_item/relations/content(mob/user)
	...
	. += "<hr>"
	. += "<br><b>Что они знают о вас? Это общая информация, которую будут знать все ваши персонажи, состоящие в механических отношениях с вами. <a href='?src=\ref[src];relation_info=["general"]'>Изменить</a>"
