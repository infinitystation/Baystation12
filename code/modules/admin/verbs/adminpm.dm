...
/client/proc/cmd_admin_pm(var/client/C, var/msg = null, var/datum/ticket/ticket = null)
	...
	sender_message += ": <span class='message'>[sanitize(msg)]</span></span></span>"
	...
	receiver_message += ": <span class='message'>[sanitize(msg)]</span></span></span>"
