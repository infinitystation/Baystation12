/decl/cultural_info/faction/ascent_serpentid
	...
	description = "Представители <font color=\"#6600cc\">Восхождения</font>, как правило, организованы по родословной материнской гиины их \
...
/decl/cultural_info/faction/ascent_alate
	...
	бескомпромиссной культурой <font color=\"#6600cc\">Восхождения</font>, пользуясь своими передними конечностями с лезвиями. Среди Кхармании \
