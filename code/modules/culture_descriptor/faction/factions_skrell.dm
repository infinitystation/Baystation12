...
/decl/cultural_info/faction/skrell/yiitalana
	...
	description = "Уии'талана - ОСС из глубины территорий Скреллианский Империи, вдали от ее границ , в тех \
	местах, которые для людей являются тёмным пятном на карте. Уии'талана базируется в системе Ри'куора, там \
...
/decl/cultural_info/faction/skrell/qonprri
	...
	description = "Куонн'прри - независимая корпорация службы безопасности, которая работает в системе Харр'клем \
	...
	Куонн'прри - это лишь часть Квала'оа, которому поручено собирать информацию в человеческом пространстве и \
	вдоль границы. До сих пор такие заявления были необоснованными, и Куонн'прри всё еще остается известен тем, \
