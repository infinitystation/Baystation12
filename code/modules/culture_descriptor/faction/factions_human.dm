...
/decl/cultural_info/faction/gcc
	...
	description = "The Independent Colonial Confederation of Gilgamesh, commonly referred to as the Terran Colonial Confederation (TCC), is a regional power in human space,\
	...
	scale conflict between the SCG and TCC that saw a great deal of death and destruction. In Sol space \"Indies\" as they are known are \
