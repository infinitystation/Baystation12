...
/decl/cultural_info/culture/unathi_tersten
	...
	description = "Кланы <font color=\"#c0c0c0\">синта</font>, которые обосновались на Терстене, - это нечто странное. Многие поселились на планете в самом начале \
	...
	убеждениях, <font color=\"#c0c0c0\">синта</font> на Терстене хорошо интегрировались с жителями планеты. Кланы Терстена рассматриваются некоторыми кланами Могеса как предатели, которые \
	покинули свою родину. Несмотря на это, Терстенские <font color=\"#54654c\">унати</font> наслаждаются миром, который не может быть достигнут на грубой поверхности Могеса."
	language = LANGUAGE_UNATHI_SINTA
	secondary_langs = list(
		LANGUAGE_UNATHI_YEOSA,
		LANGUAGE_SIGN,
