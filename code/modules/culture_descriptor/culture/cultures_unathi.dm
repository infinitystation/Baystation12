/decl/cultural_info/culture/unathi
	...
	Положение в обществе унатхов будет основываться на том, из какого вы региона, какой веры вы придерживаетесь \
	и какой клан для вас является домом. Все в их культуре связано с традициями и ценностями этих вещей, и они \
