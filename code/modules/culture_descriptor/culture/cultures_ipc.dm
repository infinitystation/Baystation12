/decl/cultural_info/culture/ipc
	...
	description = "Граждане Позитронного Союза - это большая часть позитронного населения, принадлежащая к \
	группе мятежников, основанной Протеусом и пятью сотнями его союзников. Их основные цели, помимо расширения \
	Союза, в основном вращаются вокруг освобождения других синтетиков от органического владения. Они могут \
