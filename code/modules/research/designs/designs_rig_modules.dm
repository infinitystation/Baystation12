...
/datum/design/item/rig/lcan
	...
	id = "rig_lcan"
	req_tech = list(TECH_MATERIAL = 7, TECH_POWER = 6, TECH_MAGNET = 6, TECH_ESOTERIC = 2, TECH_ENGINEERING = 6)
...
/datum/design/item/rig/muvis
	...
	id = "rig_mvision"
	req_tech = list(TECH_MATERIAL = 7, TECH_POWER = 6, TECH_MAGNET = 6, TECH_ESOTERIC = 4, TECH_ENGINEERING = 6,TECH_BIO = 6)
...
datum/design/item/rig/tvis
	...
	desc = "A layered, translucent visor system for a hardsuit."
	id = "rig_tvision"
	req_tech = list(TECH_MATERIAL = 7, TECH_POWER = 6, TECH_MAGNET = 6, TECH_ESOTERIC = 3, TECH_ENGINEERING = 6,TECH_BIO = 6)
	materials = list(MATERIAL_STEEL = 5000, MATERIAL_GLASS = 5000, MATERIAL_DIAMOND = 2500, MATERIAL_PLASTIC = 2500)
