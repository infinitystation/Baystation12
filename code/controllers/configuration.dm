...
//	var/enable_authentication = 0		// goon authentication
	...
	var/alert_desc_blue_upto = "—танция получила возможную информацию о возможной враждебной угрозе на станции. —отрудники службы безопасности могут носить оружие на виду, случайные обыски разрешены."
	var/alert_desc_blue_downto = "Ќепосредственная угроза миновала. ќфицеры службы безопасности больше не могут использовать оружие у всех на виду, но могут по-прежнему носить его. —лучайные поиски по-прежнему разрешены."
