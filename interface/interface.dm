...
\tCtrl+f = переключить режим взааимодействия-влево
\tCtrl+g = переключить режим взааимодействия-вправо
...
\tCtrl+4 = переключить режим взааимодействия (интент)
\tF1 = АХ
\tF2 = OOC
\tF3 = сказать
\tF4 = эмоция
\tDEL = тянуть
\tINS = переключить режим взааимодействия (интент)
