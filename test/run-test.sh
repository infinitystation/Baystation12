...
function run_code_tests {
    ...
    run_test "check changelog example unchanged" "md5sum -c - <<< '683a3e0d21b90581ae6e4c95052d461e *html/changelogs_infinity/example.yml'"
    ...
    run_test_ci "check changelog builds" "python3 tools/GenerateChangelog/ss13_ru_genchangelog.py html/changelog_infinity.html html/changelogs_infinity"
}
