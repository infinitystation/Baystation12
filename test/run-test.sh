...
function run_code_tests {
    ...
    run_test "check changelog example unchanged" "md5sum -c - <<< '0f63ec0431a7007c151baf3b354530ba *html/changelogs/example.yml'"
...
function run_byond_tests {
    ...
    run_test "check globals unchanged" "md5sum -c - <<< 'c75a991876644f3b78e8c6bfd9a1ec90 *code/_helpers/global_access.dm'"
