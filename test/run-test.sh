...
function run_code_tests {
    ...
    run_test "check changelog example unchanged" "md5sum -c - <<< '80c39b95ef8e53af5dbfe03b786f6d97 *html/changelogs/example.yml'"
...
function run_byond_tests {
    ...
    run_test "check globals unchanged" "md5sum -c - <<< '15fd2bd837204fdab70a2631c25bb067 *code/_helpers/global_access.dm'"
