/obj/item/clothing/under/rank/security/alt
	...
	item_icons = list(
		...
		icon_l_hand = 'infinity/icons/blue_brig/mob/clothing-lefthand.dmi',
		icon_r_hand = 'infinity/icons/blue_brig/mob/clothing-righthand.dmi'
		)
...
/obj/item/clothing/under/rank/security/navyblue/alt
