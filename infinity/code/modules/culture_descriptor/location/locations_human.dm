/decl/cultural_info/location/human
	secondary_langs = list(LANGUAGE_SIGN, LANGUAGE_SPACER, LANGUAGE_GUTTER, LANGUAGE_HUMAN_RUSSIAN)

/decl/cultural_info/location/human/earth
	secondary_langs = list(LANGUAGE_SIGN, LANGUAGE_SPACER, LANGUAGE_GUTTER, LANGUAGE_HUMAN_RUSSIAN)

/decl/cultural_info/location/human/luna
	secondary_langs = list(LANGUAGE_SIGN,LANGUAGE_HUMAN_EURO, LANGUAGE_SPACER)

/decl/cultural_info/location/human/venus
	secondary_langs = list(LANGUAGE_SIGN, LANGUAGE_SPACER, LANGUAGE_GUTTER, LANGUAGE_HUMAN_RUSSIAN)

/decl/cultural_info/location/human/ceres
	secondary_langs = list(LANGUAGE_SIGN, LANGUAGE_HUMAN_EURO, LANGUAGE_GUTTER)
