...
/decl/cultural_info/faction/skrell/qonprri
	...
	description = "Куонн'прри - независимая корпорация службы безопасности, которая работает в системе Харр'клем в западной части Скреллианской Империи. Предоставляет частные услуги безопасности различным судам, торговцам и организациям скреллов, а в последнее время - и человеческим корпорациям. Неофициально ходят слухи, что Куонн'прри - это лишь часть Квала'оа, которому поручено собирать информацию в человеческом пространстве и вдоль границы. До сих пор такие заявления были необоснованными, и Куонн'прри всё еще остается известен тем, что предлагает профессиональный, надежный, и обученный охранный персонал для людей и скреллов. За разумную плату, разумеется."
	additional_langs = list(LANGUAGE_HUMAN_EURO)
	economic_power = 1.4
	subversive_potential = 60
