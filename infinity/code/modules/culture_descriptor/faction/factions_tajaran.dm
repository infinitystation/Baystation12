/decl/cultural_info/faction/tajaran
	...
	а они не очень любят тебя. Но зато твой клан любит деньги и имеет множество коммерческих пактов с трансзвездными корпорациями,\
...
/decl/cultural_info/faction/tajaran/kaytam
	description = "Конечно, клан Кайтам трудно назвать самым благополучным, богатым кланом, но он твой - и потому он лучший.\
	А еще твой клан вложил самый большой вклад в победу над надзирателями и армия у твоего клана самая сильная! \
	Кайтам - луший клан, все же в нашем клане так говорят, потому так наверное и есть. \
...
/decl/cultural_info/faction/tajaran/kaytam/ksd
	...
	description = "Кхан-Схану'Дар - один из крупнейших подкланов Кайтам, но обладающий гораздо большей независимостью и сувернитетом. \
	Твой клан идет по пути социализма, равенства и свободы. Таяра в других кланах могут быть богаче, свободнее, но ты знаешь что \
	твой клан не бросит тебя в беде. Дружба, братсво, равенство и взаимовыручка - основные постулаты представителей этого клана.\
...
/decl/cultural_info/faction/tajaran/nazkiin
	...
	description = "Ты - выходец из клана Назкин, одного из наиболее консервативных кланов. Они известны своей любовью \
