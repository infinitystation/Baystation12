...
/decl/cultural_info/faction/vox/apex
	...
	description = "Редко, но не безизвестно, что апекс принимает непосредственное участие в жизни своих «детей». Те воксы, которые отобраны и отмечены этими богоподобными машинами ковчегов, пользуются повышенным социальным положением. Они рассматриваются как «неприкасаемые» в некотором смысле, но, в свою очередь, отстранены от своих предыдущих социальных связей. Быть бого-приложенным - это одинокая работа, и зачастую она невероятно трудна, но не без наград. Физические аугментации и умственные апгрейды, древние технологии ауралис и совершенствование сознания личности могут быть дарованы апексом любимой его пешки."
