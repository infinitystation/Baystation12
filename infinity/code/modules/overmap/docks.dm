...
/obj/docking_port/ex_act()
	if(current_connected)
		visible_message("<span class = 'notice'>The explosion disconnects the docking port!</span>")
...
/obj/docking_port/MouseDrop(var/obj/over_object)
	...
	if(istype(over_object,/obj/vehicle) || istype(over_object,/mob/living/exosuit)) return //Yeah no vehicles-through-dock thanks. use a dropship.
...
/* TODO DELETE
	if(istype(connect_to,/obj/effect/overmap/ship/npc_ship))
		...
		if(!ship.can_board())
			to_chat(user,"<span class = 'notice'>[ship] is too functional to force a dock connection.</span>")
			return
		ship.load_mapfile()
*/
...
/* TODO for ascents
/obj/docking_port/covenant
	icon = 'infinity/icons/obj/overmap/ascent_docking_port.dmi'

/obj/docking_port/covenant/north
	dir = NORTH

/obj/docking_port/covenant/south
	dir = SOUTH
	pixel_y = -96

/obj/docking_port/covenant/east
	dir = EAST
	pixel_x = 0

/obj/docking_port/covenant/west
	dir = WEST
	pixel_x = -96
*/

/obj/docking_port/one_way
	desc = "This dock permits extension and docking, but does not allow objects to dock at it."
...
/* TODO for ascents
/obj/docking_port/one_way/covenant
	icon = 'infinity/icons/obj/overmap/ascent_docking_port.dmi'

/obj/docking_port/one_way/covenant/north
	dir = NORTH

/obj/docking_port/one_way/covenant/south
	dir = SOUTH
	pixel_y = -96

/obj/docking_port/one_way/covenant/east
	dir = EAST
	pixel_x = 0

/obj/docking_port/one_way/covenant/west
	dir = WEST
	pixel_x = -96
*/
