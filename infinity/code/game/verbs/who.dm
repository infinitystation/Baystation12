...
/client/verb/staffwho()
	...
	if(config.admin_irc)
		to_chat(src, "<span class='info'>Ваш запрос на помощь могут увидеть админы в дискорде. Если администрации нет на сервере, всё равно попробуйте написать, возможно вам ответят оттуда.</span>")
