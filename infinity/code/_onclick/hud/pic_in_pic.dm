...
/obj/screen/movable/pic_in_pic/proc/make_backgrounds()
	...
	standard_background.icon = PIC_IN_PIC_STANDART_ICON
...
/obj/screen/movable/pic_in_pic/proc/add_buttons()
	...
	if(!move_tab)
		...
		move_tab.icon = PIC_IN_PIC_STANDART_ICON
	...
	if(!button_x)
		...
		MA.name = "close"
		MA.icon = PIC_IN_PIC_STANDART_ICON
		MA.icon_state = "x"
		MA.plane = HUD_PLANE
...
//maybewillneed	y_off = -height * world.icon_size - 16
