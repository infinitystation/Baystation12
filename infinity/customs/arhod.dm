...
/obj/item/weapon/gun/energy/gun/secure/messith
	name = "messith pistol"
	desc = "Пистолет \"Мессит\" является усовершенствованной версией стандартного 'Сэрандаррита', переоборудованный под энерго-оружие. Данный пистолет выдаётся всем членам семьи 'Фусозай', как табельное оружие начиная со звания 'Мессита', чем и был прозван. Его главная особенность в отличие от стандартного компактного 'Перуна' - удлинённый ствол и облегчённая рукоятка, позволяющая стрелять точнее своего прародителя и ровестника, но минус - дороговизна и быстрый разогрев ствола при стрельбе в летальном режиме. На стволе, судя по всему, обладатель данного оружия нацарапал надпись 'Var Dar Fusozai'"
