/obj/item/custkit/custom_beret_eugen00751
	name = "dermal pouch customization kit"
	input = /obj/item/clothing/head/HoS/dermal
	output = /obj/item/clothing/head/HoS/dermal/beret/custom_eugen00751
